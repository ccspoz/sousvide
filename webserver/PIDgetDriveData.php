<?php
    ...
    try {
        ...
        $result = $conn->query('SELECT datetime, error, duty FROM '.$tblname.' WHERE datetime BETWEEN "'.$startDate.'" AND "'.$endDate.'"');

        // To get all data instead use:
        //$result = $conn->query('SELECT datetime, p, i, d FROM '.$tblname.'');
        ...
        $table['cols'] = array(
            ...
            array('label' => 'Heater Duty Cycle', 'type' => 'number')
